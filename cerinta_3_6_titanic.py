...
# --- Tabel încrucişat: supraviețuire per sex și clasă ---
print("\n=== Rata de supraviețuire per sex şi clasă ===")
...
print("\nConcluzie: Femeile şi pasagerii din clasa I au avut rate de supraviețuire semnificativ mai mari,")
